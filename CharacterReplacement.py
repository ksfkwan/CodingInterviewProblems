...
The number of occurences of the most frequent letter(s) in a valid substring plus k is greater than or equal to the length of the substring in question.
'''
