...
class Solution:
    def CharacterReplacement(self, s: str, k: int) -> int:
        ...
        for right in range(len(s)): # The right pointer is the protagonist and the first iteration is trivial.
            ...
            maxfrequency = max(maxfrequency, dictionary[s[right]]) # right - left + 1 >= maxfrequency since there are times when right - left + 1 is the only variable increasing.
            # Sometimes it reaches a point where right - left + 1 - maxfrequency = k. This is when things get interesting.
            ...
            # print(f'left, right = {left}, {right}\ndictionary, maxfrequency, result = {dictionary}, {maxfrequency}, {result}\n')
        return result
...
The new maximum frequency equals the frequency of the rightmost letter in the new window.
'''
