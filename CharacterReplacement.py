...
The algo may, depending on k, shift the current (non-empty) window if extending it does not increase the frequency. A slower way would be checking every valid window.
